 ...
 * @package schlessera/wcbtn-2018-api
 */
final class Contact extends BaseCustomPostType {
	...
	protected function get_arguments() {
		return [
			...
			'description'         => __( 'Contacts that need follow-up', 'wcbtn-2018-api' ),
	...
	private function get_labels() {
		return [
			'name'                  => _x( 'Contacts', 'Post Type General Name', 'wcbtn-2018-api' ),
			'singular_name'         => _x( 'Reminder', 'Post Type Singular Name', 'wcbtn-2018-api' ),
			'menu_name'             => __( 'Follow-up Contacts', 'wcbtn-2018-api' ),
